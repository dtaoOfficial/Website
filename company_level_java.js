let questions = [
  ...
  {
    "question": "What is the primary purpose of the `main` method in a Java application?",
    "options": ["It's the entry point for the JVM to start execution.", "It's used for defining global variables.", "It's a constructor for the main class.", "It's a method for handling exceptions."],
    "answer": "It's the entry point for the JVM to start execution."
  },
  {
  ...
  },
  {
    ...
    "options": ["Java Virtual Machine", "Java Verification Model", "Java Visual Modeler", "Joint Venture Model"],
    "answer": "Java Virtual Machine"
  },
  {
    "question": "How do you create an object of a class named `MyClass`?",
    "options": ["`MyClass obj = new MyClass();`", "`MyClass obj;`", "`new MyClass();`", "`create MyClass obj;`"],
  ...
  },
  {
    ...
    "options": ["`do-while`", "`for`", "`while`", "`if-else`"],
    "answer": "`do-while`"
  },
  {
    "question": "What is an array in Java?",
    "options": ["A collection of elements of the same data type stored in contiguous memory locations.", "A way to store key-value pairs.", "A dynamic list that can grow or shrink.", "A method for handling exceptions."],
